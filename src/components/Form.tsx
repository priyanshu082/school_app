...
interface FormData {
  ...
  return (
    <Card className="w-[98vw] flex flex-col   ">
      <CardHeader>
      ...
      <CardContent>
        ...
        <form className="space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <FormField label="Sub Center" required>
              <Select onValueChange={(value) => handleInputChange('subCenter', value)}>
                <SelectTrigger>
                  <SelectValue placeholder="Select sub center" />
                </SelectTrigger>
                <SelectContent>
                  {subCenters.map(subCenter => (
                    <SelectItem key={subCenter} value={subCenter}>{subCenter}</SelectItem>
                  ))}
                </SelectContent>
              </Select>
            </FormField>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <FormField label="Address" required>
                  <Input
                    ...
                    onChange={(e) => handleInputChange('corrAddress', e.target.value)}
                  />
                </FormField>
                ...
                <FormField label="Pincode" required>
                  <Input
                    ...
                    onChange={(e) => handleInputChange('corrPincode', e.target.value)}
                  />
                </FormField>
              </div>
            )}
